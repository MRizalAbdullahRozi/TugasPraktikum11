...
$query = mysqli_query($conn,"select * from persertadidikbaru");
$i = 2;
...

{
    ...
    $sheet->setCellValue('E'.$i, $row['tmplahir']);
    $sheet->setCellValue('F'.$i, $row['tglahir']);
    $sheet->setCellValue('G'.$i, $row['noreg']);
